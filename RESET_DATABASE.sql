-- Reset database script for development purposes
-- WARNING: This will delete all data in the Masroo3k database
...
-- 1. After executing the above statements, select the "Masroo3k" database from the left panel
-- 2. Then execute the remaining statements below one by one

-- Step 2: Select the database (uncomment this line when executing in a new query)
-- USE Masroo3k;
...
-- Execute these statements after all tables are created
...
-- Execute these after the tables are created
...
-- Step 10: Insert default users
-- Passwords are hashed using BCrypt with 11 rounds
-- admin123 -> $2a$11$8hS8vF8mYOAbC.0vDgF0yOvZaPq4hZ2Q8lS5P9yT8nR4qZ2Q8lS5O
-- user123 -> $2a$11$8hS8vF8mYOAbC.0vDgF0yOvZaPq4hZ2Q8lS5P9yT8nR4qZ2Q8lS5O
...
-- Step 11: Insert default templates
...
-- Step 12: Set AUTO_INCREMENT values
